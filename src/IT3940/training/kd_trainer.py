...
class KDTrainer:
    ...
    def evaluate(
        ...
        """Evaluate student with CE loss + accuracy only (no teacher / KD / ranks)."""
        self.student.eval()
        ...
        total_loss, total_correct, total_samples = _reduce_eval_sums(
            total_loss, total_correct, total_samples, self.device
        )
