...
from IT3940.training.supervised import train_one_epoch, evaluate, save_checkpoint
import random
import numpy as np
import torch
...
def main() -> None:
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        print(f"Epoch {epoch}/{num_epochs}, LR: {current_lr:.6f}, Train Loss: {train_metrics['loss']:.4f}, Train Accuracy: {train_metrics['accuracy']:.4f}, Test Loss: {test_metrics['loss']:.4f}, Test Accuracy: {test_metrics['accuracy']:.4f}")
